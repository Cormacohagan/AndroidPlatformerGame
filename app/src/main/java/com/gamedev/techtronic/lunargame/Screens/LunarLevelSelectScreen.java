...
public class LunarLevelSelectScreen extends GameScreen {
    ...
    protected void initBitmaps() {
        ...
        mAssetManager.loadAndAddBitmap("levelCompleted", "img/menus/levelSelect/levelCompletedIcon.png");
    ...
    private void resolveTouchEvents(LunarGame game) {
        if (levelTutorial.pushTriggered()) {
            ...
            fadeToColourAndSwitchScreen("black", 5, 500, 0, 0, "LunarLevelSelectScreen");
            disableInput = true;
    ...
    public void update(ElapsedTime elapsedTime){
        ...
        if (exitScreen) {
            ...
            this.resetFade();
            prepareScreenForDisplayingAgain();
            exitScreen = false;
        }
    ...
    public void addLevelCompleted(String levelID) {
        if (levelID == "level_tutorial") {
            levelTutorial.setBitmaps("levelCompleted", "levelCompleted");
        }
        else if (levelID == "level_one") {
            levelOne.setBitmaps("levelCompleted", "levelCompleted");
        }
        else if (levelID == "level_boss") {
            levelBoss.setBitmaps("levelCompleted", "levelCompleted");
        }
    }

    public void prepareScreenForDisplayingAgain(){
        stopUpdatingButtons = false;
        disableInput = false;
    }
