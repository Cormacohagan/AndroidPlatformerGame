...
public abstract class GameScreen {
	...
	protected boolean screenCurrentlyFading = false, exitScreen = false, disableInput = false, temporarilyDisableInput = false;
	...
	protected void fadeToColourAndSwitchScreen(final String colour, final int fadeRate, final int delayBeforeFade, final int delayAfterFade, final int startingOpacity, final String screenToFadeTo) {
		...
		Runnable fadeToColour = new Runnable() {
			public void run() {
				...
				fadePaint.setAlpha(startingOpacity);
				...
				int fadeValue = startingOpacity;
				screenCurrentlyFading = true;
	...
	protected void fadeToColour(final String colour, final int fadeRate, final int delayBeforeFade, final int delayAfterFade, final int opacity) {
