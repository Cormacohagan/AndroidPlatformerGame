package com.gamedev.techtronic.lunargame.gage.engine.input;

import com.gamedev.techtronic.lunargame.R;
import com.gamedev.techtronic.lunargame.gage.util.Pool;
...
public class KeyHandler implements OnKeyListener {
	...
	public boolean isKeyPressed(int keyCode) {
		return !(keyCode < 0 || keyCode > 127) && mPressedKeys[keyCode];
	}
