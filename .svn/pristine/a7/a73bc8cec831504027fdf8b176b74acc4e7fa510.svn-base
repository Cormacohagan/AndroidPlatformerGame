...
public class Sprite extends GameObject {
	 ...
	 */
	public static float DEFAULT_MAX_ACCELERATION = 300;
	public static float DEFAULT_MAX_VELOCITY = 5000;
	 ...
	 * 
	 * @see
	 * com.gamedev.techtronic.lunargame.gage.world.GameObject#update(com.gamedev.techtronic.lunargame.gage.engine
	 * .ElapsedTime)
	 */
	@Override
