package com.gamedev.techtronic.lunargame.gage;

import android.app.Fragment;
import com.gamedev.techtronic.lunargame.R;
		...
		public void run() {
			...
			try {
				while (running) {
					...
					elapsedTime.totalTime = (currentTime - startRun) / 1000000000.0; // stores total run time
					elapsedTime.stepTime = (currentTime - startStep) / 1000000000.0; // stores how much time has passed since start of this frame
